...
//		 be used to authenticate requests
		...
		public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
			HttpSecurity authorizeHttpRequests2 = http
					...
					.authorizeHttpRequests(authorizeHttpRequests -> {
						try {
							authorizeHttpRequests
									...
									.requestMatchers(HttpMethod.POST, "/api/v1/auth/refresh-token", "/api/v1/auth/enable-user/**",
											"/api/v1/auth/authenticate", "/api/v1/auth/forgot-password",
											"/api/v1/auth/reset-password", "/api/v1/auth/register/**","/api/v1/auth/delete/**")
									.permitAll()
